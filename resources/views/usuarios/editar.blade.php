        ...
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg m-5">
            <div class="grid lg:grid-cols-3 grid-cols-1 gap-4 p-5">
                <div class="col-span-1">
                    ...
                    <input id="name" name = "name" type="text" class="px3 py2 w-full rounded-x1 bg-blue-100" value="{{ $usuario->name }}">
                    @error('name')
                ...
                <div class="col-span-1">
                    ...
                    <input id="email" name = "email" type="text" class="px3 py2 w-full rounded-x1 bg-blue-100" value="{{ $usuario->email }}">
                    @error('email')
                ...
                <div class="col-span-1">
                    ...
                    <input id="telefono" name = "telefono" type="integer" class="px3 py2 w-full rounded-x1 bg-blue-100" value="{{ $usuario->telefono }}" 
                ...
                <div class="col-span-1">
                    ...
                    <input id="ci" name = "ci" type="integer" class="px3 py2 w-full rounded-x1 bg-blue-100" value="{{ $usuario->ci }}" 
                ...
                <div class="col-span-1">
                    ...
                    <input id="direccion" name = "direccion" type="text" class="px3 py2 w-full rounded-x1 bg-blue-100" value="{{ $usuario->direccion }}" 
