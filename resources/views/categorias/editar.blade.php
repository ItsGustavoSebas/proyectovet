        ...
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg m-5">
            <div class="grid lg:grid-cols-3 grid-cols-1 gap-4 p-5">
                <div class="col-span-1">
                    ...
                    <input id="Nombre" name = "Nombre" type="text" class="px3 py2 w-full rounded-xl bg-blue-100" value="{{ $categoria->Nombre }}"
                ...
                <div class="col-span-1">
                    ...
                    <input id="Descripcion" name = "Descripcion" type="text" class="px3 py2 w-full rounded-xl bg-blue-100" value="{{ $categoria->Descripcion }}"
