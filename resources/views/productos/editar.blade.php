            ...
            <div class="grid lg:grid-cols-3 grid-cols-1 gap-4 p-5">
                <div class="relative z-0">
                    <input id="nombre" type="text" name="nombre"
                        ...
                        value="{{ $Producto->nombre }}" placeholder=" " />
                    <label
                ...
                <div class="relative z-0">
                    ...
                    <select name="sexo" id="sexo" class="form-control">
                        <option value="M" {{ $Producto->sexo == 'M' ? 'selected' : '' }}>Macho</option>
                        <option value="H" {{ $Producto->sexo == 'H' ? 'selected' : '' }}>Hembra</option>
                    </select>
                </div>
                <div class="relative z-0">
                    <input id="color" type="text" name="color"
                        class="peer block w-full appearance-none border-0 border-b border-gray-500 bg-transparent py-2.5 px-0 text-sm text-gray-900 focus:border-blue-600 focus:outline-none focus:ring-0"
                        value="{{ $Producto->color }}" placeholder=" " />
                    <label
                ...
                <div class="relative z-0">
                    <input id="fechaNacimiento" type="date" name="fechaNacimiento"
                        class="peer block w-full appearance-none border-0 border-b border-gray-500 bg-transparent py-2.5 px-0 text-sm text-gray-900 focus:border-blue-600 focus:outline-none focus:ring-0"
                        value="{{ $Producto->fechaNacimiento }}" placeholder=" " />
                    <label
                ...
                <label class="flex radio p-2 cursor-pointer font-extralight text-xs">
                    <input class="my-auto transform scale-125" type="checkbox" name="esterilizado" id="esterilizado" value="1" {{ $Producto->esterilizado ? 'checked' : '' }} />
                ...
                <div class="relative z-0">
                    <input id="edad" type="text" name="edad"
                        class="peer block w-full appearance-none border-0 border-b border-gray-500 bg-transparent py-2.5 px-0 text-sm text-gray-900 focus:border-blue-600 focus:outline-none focus:ring-0"
                        value="{{ $Producto->edad }}" placeholder=" " />
                    <label
                ...
                <div class="relative z-0">
                    ...
                    <select name="ID_Especie" id="ID_Especie">
                        ...
                        @foreach ($especies as $especie)
                            <option value="{{ $especie->id }}" {{ $Producto->ID_Especie == $especie->id ? 'selected' : '' }}>{{ $especie->nombre }}</option>
                        @endforeach
                ...
                <div class="relative z-0">
                    ...
                    <select name="ID_Raza" id="ID_Raza">
                        ...
                        @foreach ($razas as $raza)
                            <option value="{{ $raza->id }}" {{ $Producto->ID_Raza == $raza->id ? 'selected' : '' }}>{{ $raza->nombre }}</option>
                        @endforeach
                ...
                <div class="relative z-0">
                    <input id="ID_Cliente" type="text" name="ID_Cliente"
                        class="peer block w-full appearance-none border-0 border-b border-gray-500 bg-transparent py-2.5 px-0 text-sm text-gray-900 focus:border-blue-600 focus:outline-none focus:ring-0"
                        value="{{ $Producto->ID_Cliente }}" placeholder=" " />
                    <label
                ...
                <div class="relative z-0">
                    <input id="peso" type="text" name="peso"
                        class="peer block w-full appearance-none border-0 border-b border-gray-500 bg-transparent py-2.5 px-0 text-sm text-gray-900 focus:border-blue-600 focus:outline-none focus:ring-0"
                        value="{{ $Producto->historial->peso }}" placeholder=" " />
                    <label
                ...
                <div class="relative z-0">
                    <input id="altura" type="text" name="altura"
                        class="peer block w-full appearance-none border-0 border-b border-gray-500 bg-transparent py-2.5 px-0 text-sm text-gray-900 focus:border-blue-600 focus:outline-none focus:ring-0"
                        value="{{ $Producto->historial->altura }}" placeholder=" " />
                    <label
                ...
                <div class="relative z-0">
                    <input id="observacion" type="text" name="observacion"
                        class="peer block w-full appearance-none border-0 border-b border-gray-500 bg-transparent py-2.5 px-0 text-sm text-gray-900 focus:border-blue-600 focus:outline-none focus:ring-0"
                        value="{{ $Producto->historial->observacion }}" placeholder=" " />
                    <label
