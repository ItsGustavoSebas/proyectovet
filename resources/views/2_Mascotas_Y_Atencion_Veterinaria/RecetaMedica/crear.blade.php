<x-app-layout>
        ...
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg m-5">
            ...
            <div class="p-5">
                ...
                <button type="button" id="agregarMedicamento"
                    ...
                    onclick="mostrarConfirmacion()">Agregar Medicamento</button>
    ...
    <script>
        function mostrarConfirmacion() {
            Swal.fire({
                title: '¿Estás seguro de agregar producto?',
                icon: 'question',
                ...
                if (result.isConfirmed) {
                    // Llamar a la función que agrega productos solo si el usuario confirma
                    agregarProducto();
                }
            });
        }
