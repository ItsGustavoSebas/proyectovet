        ...
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg m-5">
            <div class="grid lg:grid-cols-3 grid-cols-1 gap-4 p-5">
                <div class="col-span-1">
                    ...
                    <input id="diagnostico" name = "diagnostico" type="text" class="px3 py2 w-full rounded-x1 bg-blue-100" 
                ...
                <div class="col-span-1">
                    ...
                    <input id="precio" name = "precio" type="text" class="px3 py2 w-full rounded-x1 bg-blue-100" 
