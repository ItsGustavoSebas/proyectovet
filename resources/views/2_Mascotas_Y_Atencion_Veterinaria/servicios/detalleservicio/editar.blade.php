<x-app-layout>
    ...
    <head>
        ...
        <title>Editar_detalle_servicio</title>
    </head>
        ...
        <div class="bg-gradient-to-r from-indigo-700 to-indigo-950 p-8">
            ...
            <div class="bg-gray-100 p-4 overflow-hidden shadow-xl sm:rounded-lg m-5 ">
                ...
                <div>
                        ...
                        <div class="w-full px-3 mb-5">
                            <div class="flex">
                                ...
                                <input id= "Tiempo" type="string" name="Tiempo"
                                    ...
                                    placeholder="Ingresar Tiempo" value="{{ old('Tiempo', $detalleservicio->Tiempo)}}">
                                @error('Tiempo')
                    ...
                    <div class="relative z-0">
                        <select name="ID_Servicio" id="ID_Servicio">
                            ...
                            @foreach ($servicios as $servicio)
                                <option value="{{ $servicio->id }}" @if ($detalleservicio->ID_Servicio == $servicio->id) selected @endif>
                                    {{ $servicio->nombre }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <input type="hidden" name="ID_Cita" id="ID_Cita" value="{{ $detalleservicio->ID_Cita }}">
                    <input type="hidden" name="ID_Empleado" id="ID_Empleado" value="{{ $detalleservicio->ID_Empleado }}">
                </div>
            </div>
        </div>
    </form>
